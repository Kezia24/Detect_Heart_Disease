...
import pickle #pmbacaan model
from sklearn.preprocessing import LabelEncoder #labeling input

#PEMBUATAN MODEL
with open('best_model1.pkl', 'rb') as file:
	model = pickle.load(file)
		
#PREPROCESSING (Model terhadap input)
...
st.image("gambar jantungan.jpg",caption="Heart Disease Awareness", use_column_width=True)
...
#PREPROCESSIING DATA (Input terhadap model)
